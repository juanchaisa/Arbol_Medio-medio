...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Feliz día de la mujer mi señorita hermosa, no olvide que la quiero un buen...bueno maso JA`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Ya hace falta besitos eh... ";
...
function showCountdown() {
  ...
  function update() {
    ...
    container.innerHTML =
      ...
      `Nuestro aniversario para que no se olvide otra vez: <b>${eventDays}d ${eventHours}h ${eventMinutes}m ${eventSeconds}s</b>`;
